...
export default function ModerationScreen() {
  ...
  const Columns = [
    "Suspect level", "Generator" , "Model", "Prompt", "Date", 
    "Time", "User ID"
  ];
    ...
    <div className='moderation_wrapper'>
      <div className="top_heading">
        ...
        <button className="start_over_btn">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M20.8216 15C19.5618 18.8327 15.9539 21.6 11.6996 21.6C6.39768 21.6 2.09961 17.302 2.09961 12C2.09961 6.69809 6.39768 2.40002 11.6996 2.40002C14.8094 2.40002 17.5739 3.87872 19.3283 6.17137M20.0153 7.20002C19.8081 6.84187 19.5785 6.49834 19.3283 6.17137M19.3283 6.17137L17.0996 8.40002H21.8996V3.60002L19.3283 6.17137ZM19.4996 8.00002L20.9996 6.00002" stroke="#343434" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
          Start over
        </button>
      </div>
                  ...
                  {tableData.map((row) => (
                    <TableRow key={row['uuid']}>
                      <TableCell align="center">
                        ...
                        {showDoneIcon() ? <div className='level_status'><img src={Approve_icon} alt="" /><span>Approved</span></div> : <div className='level_status'><img src={blocked_icon} alt="" /><span>Blocked</span></div>}
                      </TableCell>
